...
\hypertarget{kaist-model-2}{%
\chapter{KAIST Model 2}\label{kaist-model-2}}
...
\NormalTok{\_axial }\OperatorTok{=}\NormalTok{ \_radial}
\NormalTok{\_outer }\OperatorTok{=}\NormalTok{ \_radial}
...
\NormalTok{\_friction }\OperatorTok{=} \DecValTok{43}
...
\StringTok{           size }\SpecialCharTok{\{radial\}}\StringTok{ }\SpecialCharTok{\{axial\}}\StringTok{ 20 }\SpecialCharTok{\{outer\}}\StringTok{ ...}
...
\StringTok{         size }\SpecialCharTok{\{radial\}}\StringTok{ }\SpecialCharTok{\{axial\}}\StringTok{ }\SpecialCharTok{\{outer\}}\StringTok{ ...}
...
\StringTok{\textquotesingle{}brick4\textquotesingle{}}
...
\qauthor{(Peter Wroth 1973))}\end{savequote}
...
\begin{figure}[H]
\includegraphics[width=1\linewidth]{myfigureeeeee/k} \caption{Code chunk syntax}\label{fig:unnamed-chunk-95}
\end{figure}
