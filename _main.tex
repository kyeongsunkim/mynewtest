...
\NormalTok{\_K }\OperatorTok{=} \FloatTok{0.4286}
...
\StringTok{; ==================================================================}
\StringTok{;   Simulation of Pull{-}out for Shallow Foundation}
\StringTok{; ==================================================================}
\StringTok{model new}
\StringTok{fish automatic{-}create off}
\StringTok{[global t =  \textquotesingle{}Pull{-}out for Spread Foundation \textquotesingle{}]}
\StringTok{[t += }\SpecialCharTok{\{name\}}\StringTok{]}
\StringTok{model title [t]}
\StringTok{"""}\NormalTok{.}\BuiltInTok{format}\NormalTok{(name}\OperatorTok{=}\StringTok{"(B=6.5m, D=7.45m, Dr=78\%)"}\NormalTok{))}
...
\StringTok{    local zftot = 0.0}
\StringTok{    loop foreach gp cap}
\StringTok{        zftot = zftot + gp.force.unbal.y(gp)}
\StringTok{    end\_loop}
\StringTok{    vert\_load = zftot / (0.25*0.5*0.5*math.pi)}
\StringTok{end}
...
\begin{Shaded}
\begin{Highlighting}[]
\OperatorTok{;}\NormalTok{  Calculate PY Curves at equidistant locations along pile}
\OperatorTok{;}
\OperatorTok{;}\NormalTok{ Stored }\KeywordTok{in} \BuiltInTok{map}\NormalTok{ called pile, key }\OperatorTok{=} \DecValTok{10}\OperatorTok{*}\NormalTok{z positions rounded to integer}
\OperatorTok{;}\NormalTok{    value }\OperatorTok{=} \BuiltInTok{map}\NormalTok{, key }\StringTok{\textquotesingle{}z\textquotesingle{}} \OperatorTok{=}\NormalTok{ z}\OperatorTok{{-}}\NormalTok{position}
\OperatorTok{;}                     \StringTok{\textquotesingle{}length\textquotesingle{}} \OperatorTok{=}\NormalTok{ length of ownership of this segment}
\OperatorTok{;}                     \StringTok{\textquotesingle{}gp\textquotesingle{}} \OperatorTok{=}\NormalTok{ Gridpoint nearest (}\DecValTok{0}\NormalTok{,}\DecValTok{0}\NormalTok{,z)}
\OperatorTok{;}                     \StringTok{\textquotesingle{}nodes\textquotesingle{}} \OperatorTok{=} \BuiltInTok{map}\NormalTok{ of interface nodes at that position, key order entered.}
\NormalTok{fish define make\_pydata}
    \KeywordTok{global}\NormalTok{ pile }\OperatorTok{=} \BuiltInTok{map}
    \OperatorTok{;}\NormalTok{ Build }\BuiltInTok{list}\NormalTok{ of nodes}
\NormalTok{    loop foreach local ipnt inter.}\BuiltInTok{list}
\NormalTok{        loop foreach node inter.node.}\BuiltInTok{list}\NormalTok{(ipnt)}
\NormalTok{            local z }\OperatorTok{=}\NormalTok{ inter.node.pos.z(node)}
\NormalTok{            local key }\OperatorTok{=}\NormalTok{ math.}\BuiltInTok{round}\NormalTok{(inter.node.pos.z(node) }\OperatorTok{*} \FloatTok{10.0}\NormalTok{)}
            \ControlFlowTok{if} \BuiltInTok{map}\NormalTok{.has(pile,key) }\OperatorTok{==}\NormalTok{ false then}
\NormalTok{                local level }\OperatorTok{=} \BuiltInTok{map}
\NormalTok{                local nodes }\OperatorTok{=} \BuiltInTok{map}
\NormalTok{                level(}\StringTok{\textquotesingle{}z\textquotesingle{}}\NormalTok{) }\OperatorTok{=}\NormalTok{ z}
\NormalTok{                level(}\StringTok{\textquotesingle{}gp\textquotesingle{}}\NormalTok{) }\OperatorTok{=}\NormalTok{ gp.near(}\DecValTok{0}\NormalTok{,}\DecValTok{0}\NormalTok{,z,}\StringTok{\textquotesingle{}pile\textquotesingle{}}\NormalTok{)}
\NormalTok{                level(}\StringTok{\textquotesingle{}nodes\textquotesingle{}}\NormalTok{) }\OperatorTok{=}\NormalTok{ nodes}
\NormalTok{                level(}\StringTok{\textquotesingle{}length\textquotesingle{}}\NormalTok{) }\OperatorTok{=} \FloatTok{0.0}
\NormalTok{                pile(key) }\OperatorTok{=}\NormalTok{ level}
\NormalTok{            endif}
\NormalTok{            level }\OperatorTok{=}\NormalTok{ pile(key)}
\NormalTok{            nodes }\OperatorTok{=}\NormalTok{ level(}\StringTok{\textquotesingle{}nodes\textquotesingle{}}\NormalTok{)}
\NormalTok{            nodes(}\BuiltInTok{map}\NormalTok{.size(nodes)) }\OperatorTok{=}\NormalTok{ node}
\NormalTok{            level(}\StringTok{\textquotesingle{}nodes\textquotesingle{}}\NormalTok{) }\OperatorTok{=}\NormalTok{ nodes}
\NormalTok{            pile(key) }\OperatorTok{=}\NormalTok{ level}
\NormalTok{        end\_loop}
\NormalTok{    end\_loop}
    \OperatorTok{;}\NormalTok{ Calculate length of ownership of each segment}
\NormalTok{    local prev\_key }\OperatorTok{=} \StringTok{\textquotesingle{}0\textquotesingle{}}
\NormalTok{    loop foreach key }\BuiltInTok{map}\NormalTok{.keys(pile)}
        \ControlFlowTok{if} \BuiltInTok{type}\NormalTok{.name(prev\_key) }\OperatorTok{==} \StringTok{\textquotesingle{}integer\textquotesingle{}}\NormalTok{ then}
\NormalTok{            local levelp }\OperatorTok{=}\NormalTok{ pile(prev\_key)}
\NormalTok{            local leveln }\OperatorTok{=}\NormalTok{ pile(key)}
\NormalTok{            local dist }\OperatorTok{=}\NormalTok{ math.}\BuiltInTok{abs}\NormalTok{(gp.pos.z(levelp(}\StringTok{\textquotesingle{}gp\textquotesingle{}}\NormalTok{)) }\OperatorTok{{-}}\NormalTok{ gp.pos.z(leveln(}\StringTok{\textquotesingle{}gp\textquotesingle{}}\NormalTok{))) }\OperatorTok{*} \FloatTok{0.5}
\NormalTok{            levelp(}\StringTok{\textquotesingle{}length\textquotesingle{}}\NormalTok{) }\OperatorTok{=}\NormalTok{ levelp(}\StringTok{\textquotesingle{}length\textquotesingle{}}\NormalTok{) }\OperatorTok{+}\NormalTok{ dist}
\NormalTok{            leveln(}\StringTok{\textquotesingle{}length\textquotesingle{}}\NormalTok{) }\OperatorTok{=}\NormalTok{ leveln(}\StringTok{\textquotesingle{}length\textquotesingle{}}\NormalTok{) }\OperatorTok{+}\NormalTok{ dist}
\NormalTok{            pile(prev\_key) }\OperatorTok{=}\NormalTok{ levelp}
\NormalTok{            pile(key) }\OperatorTok{=}\NormalTok{ leveln}
\NormalTok{        endif}
\NormalTok{        prev\_key }\OperatorTok{=}\NormalTok{ key}
\NormalTok{    end\_loop}
\NormalTok{end}
\OperatorTok{;}
\OperatorTok{;}\NormalTok{ Output resulting data structure...}
\NormalTok{fish define output\_structure}
\NormalTok{    loop foreach local level pile}
\NormalTok{        io.out(}\StringTok{\textquotesingle{}Z{-}Position \textquotesingle{}} \OperatorTok{+}\NormalTok{ string(level(}\StringTok{\textquotesingle{}z\textquotesingle{}}\NormalTok{)))}
\NormalTok{        io.out(}\StringTok{\textquotesingle{}Length \textquotesingle{}} \OperatorTok{+}\NormalTok{ string(level(}\StringTok{\textquotesingle{}length\textquotesingle{}}\NormalTok{)))}
\NormalTok{        io.out(}\StringTok{\textquotesingle{}Gp \textquotesingle{}} \OperatorTok{+}\NormalTok{ string(gp.}\BuiltInTok{id}\NormalTok{(level(}\StringTok{\textquotesingle{}gp\textquotesingle{}}\NormalTok{))))}
\NormalTok{        local nodelist }\OperatorTok{=} \StringTok{\textquotesingle{}\textquotesingle{}}
\NormalTok{        loop foreach local node level(}\StringTok{\textquotesingle{}nodes\textquotesingle{}}\NormalTok{)}
\NormalTok{            nodelist }\OperatorTok{=}\NormalTok{ nodelist }\OperatorTok{+} \StringTok{\textquotesingle{} \textquotesingle{}} \OperatorTok{+}\NormalTok{ string(interface.node.}\BuiltInTok{id}\NormalTok{(node))}
\NormalTok{        end\_loop}
\NormalTok{        io.out(}\StringTok{\textquotesingle{}Nodes\textquotesingle{}}\OperatorTok{+}\NormalTok{nodelist)}
\NormalTok{    end\_loop}
\NormalTok{end}

\NormalTok{fish define tot\_reac}
\NormalTok{    local total }\OperatorTok{=} \FloatTok{0.0}
\NormalTok{    loop foreach local key }\BuiltInTok{map}\NormalTok{.keys(pile)}
\NormalTok{        local level }\OperatorTok{=}\NormalTok{ pile(key)}
\NormalTok{        local accum }\OperatorTok{=} \FloatTok{0.0}
\NormalTok{        loop foreach local node level(}\StringTok{\textquotesingle{}nodes\textquotesingle{}}\NormalTok{)}
\NormalTok{            local area }\OperatorTok{=} \FloatTok{2.0} \OperatorTok{*}\NormalTok{ interface.node.area(node)}
\NormalTok{            local norm }\OperatorTok{=}\NormalTok{ zone.face.normal(inter.node.target.zone(node),inter.node.target.face(node))}
\NormalTok{            local xnstress }\OperatorTok{=}\NormalTok{ inter.node.stress.normal(node) }\OperatorTok{*}\NormalTok{ norm}\OperatorTok{{-}\textgreater{}}\NormalTok{x }\OperatorTok{*} \OperatorTok{{-}}\FloatTok{1.0}
\NormalTok{            local xsstress }\OperatorTok{=}\NormalTok{ inter.node.stress.shear.x(node)}
\NormalTok{            accum }\OperatorTok{=}\NormalTok{ accum }\OperatorTok{+}\NormalTok{ (xnstress }\OperatorTok{+}\NormalTok{ xsstress) }\OperatorTok{*}\NormalTok{  area}
\NormalTok{        end\_loop}
\NormalTok{        local xdis }\OperatorTok{=}\NormalTok{ gp.disp.x(level(}\StringTok{\textquotesingle{}gp\textquotesingle{}}\NormalTok{))}
\NormalTok{        total }\OperatorTok{=}\NormalTok{ total }\OperatorTok{+}\NormalTok{ accum}
\NormalTok{        table(string(key),xdis) }\OperatorTok{=}\NormalTok{ accum}\OperatorTok{/}\NormalTok{level(}\StringTok{\textquotesingle{}length\textquotesingle{}}\NormalTok{)}
\NormalTok{    end\_loop}
\NormalTok{    tot\_reac }\OperatorTok{=}\NormalTok{ total}
\NormalTok{end}
\end{Highlighting}
\end{Shaded}
...
\OperatorTok{;}\NormalTok{   IPython Consol Output}
\OperatorTok{;} \OperatorTok{==================================================================}
\NormalTok{(}\DecValTok{1250000}\NormalTok{, }\StringTok{\textquotesingle{}zones in whole model\textquotesingle{}}\NormalTok{)}
\NormalTok{(}\DecValTok{11346}\NormalTok{, }\StringTok{\textquotesingle{}zones in shaft group.\textquotesingle{}}\NormalTok{)}
\NormalTok{(}\DecValTok{32500}\NormalTok{, }\StringTok{\textquotesingle{}zones in plate group.\textquotesingle{}}\NormalTok{)}
\NormalTok{(}\DecValTok{12500}\NormalTok{, }\StringTok{\textquotesingle{}zones in bottom group.\textquotesingle{}}\NormalTok{)}
\NormalTok{(}\DecValTok{12500}\NormalTok{, }\StringTok{\textquotesingle{}zones in up group.\textquotesingle{}}\NormalTok{)}
\NormalTok{(}\DecValTok{5000}\NormalTok{, }\StringTok{\textquotesingle{}zones in x\_side group.\textquotesingle{}}\NormalTok{)}
\NormalTok{(}\DecValTok{5000}\NormalTok{, }\StringTok{\textquotesingle{}zones in z\_side group.\textquotesingle{}}\NormalTok{)}
\NormalTok{(}\DecValTok{5000}\NormalTok{, }\StringTok{\textquotesingle{}zones in x\_side\_end group.\textquotesingle{}}\NormalTok{)}
\NormalTok{(}\DecValTok{5000}\NormalTok{, }\StringTok{\textquotesingle{}zones in z\_side\_end group.\textquotesingle{}}\NormalTok{)}

\OperatorTok{;} \OperatorTok{==================================================================}
\OperatorTok{;}\NormalTok{   FISH Consol Output}
\OperatorTok{;} \OperatorTok{==================================================================}
...
\OperatorTok{{-}{-}{-}}\NormalTok{ Property poisson }\BuiltInTok{set} \KeywordTok{in} \DecValTok{1250000}\NormalTok{ zones using the elastic model.}
...
\OperatorTok{{-}{-}{-}}\NormalTok{ Property bulk }\BuiltInTok{set} \KeywordTok{in} \DecValTok{11346}\NormalTok{ zones using the elastic model.}
\OperatorTok{{-}{-}{-}}\NormalTok{ Property shear }\BuiltInTok{set} \KeywordTok{in} \DecValTok{11346}\NormalTok{ zones using the elastic model.}
...
\OperatorTok{{-}{-}{-}}\NormalTok{ Property bulk }\BuiltInTok{set} \KeywordTok{in} \DecValTok{32500}\NormalTok{ zones using the elastic model.}
\OperatorTok{{-}{-}{-}}\NormalTok{ Property shear }\BuiltInTok{set} \KeywordTok{in} \DecValTok{32500}\NormalTok{ zones using the elastic model.}
...
\OperatorTok{{-}{-}{-}} \DecValTok{6200}\NormalTok{ gridpoints duplicated, }\DecValTok{12234}\NormalTok{ surface faces created.}
\OperatorTok{{-}{-}{-}} \DecValTok{31}\NormalTok{ gridpoints skipped on internal edge.}
\OperatorTok{{-}{-}{-}} \DecValTok{6117}\NormalTok{ faces on one side were assigned the group name Interface }\DecValTok{1} \KeywordTok{in}\NormalTok{ slot Interface.}
...
\OperatorTok{{-}{-}{-}}\NormalTok{ Property Normal Stiffness }\BuiltInTok{set} \KeywordTok{in} \DecValTok{6231}\NormalTok{ interface }\DecValTok{1}\NormalTok{ nodes.}
\OperatorTok{{-}{-}{-}}\NormalTok{ Property Shear Stiffness }\BuiltInTok{set} \KeywordTok{in} \DecValTok{6231}\NormalTok{ interface }\DecValTok{1}\NormalTok{ nodes.}
\OperatorTok{{-}{-}{-}}\NormalTok{ Property Friction }\BuiltInTok{set} \KeywordTok{in} \DecValTok{6231}\NormalTok{ interface }\DecValTok{1}\NormalTok{ nodes.}
\OperatorTok{{-}{-}{-}}\NormalTok{ Property Cohesion }\BuiltInTok{set} \KeywordTok{in} \DecValTok{6231}\NormalTok{ interface }\DecValTok{1}\NormalTok{ nodes.}
...
\OperatorTok{{-}{-}{-}} \DecValTok{1953}\NormalTok{ gridpoints duplicated, }\DecValTok{3720}\NormalTok{ surface faces created.}
\OperatorTok{{-}{-}{-}} \DecValTok{1860}\NormalTok{ faces on one side were assigned the group name Interface }\DecValTok{2} \KeywordTok{in}\NormalTok{ slot Interface.}
...
\OperatorTok{{-}{-}{-}}\NormalTok{ Property Normal Stiffness }\BuiltInTok{set} \KeywordTok{in} \DecValTok{1953}\NormalTok{ interface }\DecValTok{2}\NormalTok{ nodes.}
\OperatorTok{{-}{-}{-}}\NormalTok{ Property Shear Stiffness }\BuiltInTok{set} \KeywordTok{in} \DecValTok{1953}\NormalTok{ interface }\DecValTok{2}\NormalTok{ nodes.}
\OperatorTok{{-}{-}{-}}\NormalTok{ Property Friction }\BuiltInTok{set} \KeywordTok{in} \DecValTok{1953}\NormalTok{ interface }\DecValTok{2}\NormalTok{ nodes.}
\OperatorTok{{-}{-}{-}}\NormalTok{ Property Cohesion }\BuiltInTok{set} \KeywordTok{in} \DecValTok{1953}\NormalTok{ interface }\DecValTok{2}\NormalTok{ nodes.}
...
\OperatorTok{{-}{-}{-}}\NormalTok{ Apply conditions added to }\DecValTok{12701}\NormalTok{ gridpoints.}
...
\OperatorTok{{-}{-}{-}} \DecValTok{101}\NormalTok{ gridpoints }\ControlFlowTok{with}\NormalTok{ conflicting conditions had those conditions removed.}
\OperatorTok{{-}{-}{-}}\NormalTok{ Apply conditions added to }\DecValTok{11308}\NormalTok{ gridpoints.}
...
\OperatorTok{{-}{-}{-}} \DecValTok{101}\NormalTok{ gridpoints }\ControlFlowTok{with}\NormalTok{ conflicting conditions had those conditions removed.}
\OperatorTok{{-}{-}{-}}\NormalTok{ Apply conditions added to }\DecValTok{10601}\NormalTok{ gridpoints.}
...
\NormalTok{flac3d}\OperatorTok{\textgreater{}}\NormalTok{zone initialize}\OperatorTok{{-}}\NormalTok{stress ratio }\FloatTok{0.4286}
\OperatorTok{{-}{-}{-}}\NormalTok{ Stresses initialized }\KeywordTok{in} \DecValTok{1250000}\NormalTok{ zones.}
...
\OperatorTok{{-}{-}{-}}\NormalTok{ Initial stress state }\BuiltInTok{set} \KeywordTok{in} \DecValTok{6231}\NormalTok{ interface nodes.}
...
\OperatorTok{{-}{-}{-}}\NormalTok{ Initial stress state }\BuiltInTok{set} \KeywordTok{in} \DecValTok{1953}\NormalTok{ interface nodes.}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}[H]
\includegraphics[width=1\linewidth]{myfigureeeeee/k} \caption{Code chunk syntax}\label{fig:unnamed-chunk-68}
\end{figure}
