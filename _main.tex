...
\hypertarget{abaqus-modeling-3d-uxad00uxb828}{%
\subsection{Abaqus Modeling: 3D 관련}\label{abaqus-modeling-3d-uxad00uxb828}}

\hypertarget{mesh}{%
\subsubsection{1.1.1.1 Mesh}\label{mesh}}

-Partitioning
\#\#\#\# 1.1.1.2 Element Type
\#\#\#\# 1.1.1.3 Computing Time
\#\#\#\# 1.1.1.4 Axisymmetric Condition
...
\hypertarget{abaqus-model-running}{%
\subsection{Abaqus Model Running}\label{abaqus-model-running}}

\hypertarget{comparing-between-model-and-centrifuge-test}{%
\subsection{Comparing between Model and Centrifuge Test}\label{comparing-between-model-and-centrifuge-test}}
